...
export const sowDocuments: Record<SowPlan, SowDocument> = {
  ...
  monthly: {
    version: "monthly-sow-2026-08-11-v2",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "One actively prioritized AI automation workstream for one primary directing stakeholder.",
          "Reasonable asynchronous communication about the active workstream.",
          "Cancellation at any time through the membership billing portal. Cancellation stops the next renewal, and service continues through the current paid period.",
