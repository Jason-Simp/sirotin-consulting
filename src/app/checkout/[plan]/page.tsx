...
export default async function CheckoutPage({ params }: { params: Promise<{ plan: string }> }) {
  ...
  const description = selectedPlan === "first-week" ? "A paid, risk-free one-week trial. Review the simple SOW, work together for seven days, and continue only if you choose to." : selectedPlan === "weekly" ? "One week of AI automation partner access. Purchase another week only when you want to continue." : "An ongoing AI automation relationship with a clear SOW, simple renewal, and easy cancellation.";
