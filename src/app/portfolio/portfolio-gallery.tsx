...
const work: WorkItem[] = [
  ...
  { title: "SimplCity", image: "/portfolio/simplcity.jpg", category: "Internal systems", description: "A project and dataset operating hub for large, governed knowledge collections.", href: "/start", status: "Private system" },
  { title: "SimplDemocracy", image: "/portfolio/simpldemocracy.jpg", category: "AI products", description: "A civic-information concept built around understandable, source-grounded public knowledge.", href: "/start", status: "Concept system" },
