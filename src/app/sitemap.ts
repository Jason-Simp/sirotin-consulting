...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/workflow-automation`, lastModified: siteUpdated, changeFrequency: "monthly", priority: 0.95 },
    { url: `${base}/workflow-automation/n8n`, lastModified: siteUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/workflow-automation/monday-com`, lastModified: siteUpdated, changeFrequency: "monthly", priority: 0.9 },
