...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "WebSite",
      "@id": "https://automatemejay.com/#website",
      name: "AutomateMeJay",
      alternateName: ["Jason Sirotin", "automatemejay.com"],
      url: "https://automatemejay.com/",
      inLanguage: "en-US",
      publisher: { "@id": "https://automatemejay.com/#organization" },
    },
    {
      "@type": "Organization",
      "@id": "https://automatemejay.com/#organization",
      name: "AutomateMeJay",
      alternateName: "Jason Sirotin AI Automation Consulting",
      url: "https://automatemejay.com/",
      logo: {
        "@type": "ImageObject",
        url: "https://automatemejay.com/pwa-icon-512",
        width: 512,
        height: 512,
      },
      email: "hello@automatemejay.com",
      telephone: "+1-678-855-5169",
      founder: { "@id": "https://automatemejay.com/#jason" },
      sameAs: [
        "https://www.linkedin.com/in/jason-sirotin-455b265",
        "https://www.jasonsirotin.com/",
        "https://www.ecgprod.com/team/jason-sirotin/",
        "https://www.simplsolutions.app/company/team",
      ],
    },
    {
      "@type": "Person",
      ...
      image: "https://automatemejay.com/jason-sirotin-headshot.png",
      worksFor: { "@id": "https://automatemejay.com/#organization" },
      knowsAbout: ["AI automation", "business process automation", "AI agents", "workflow design", "human-in-the-loop systems"],
      sameAs: [
        "https://www.linkedin.com/in/jason-sirotin-455b265",
        "https://www.jasonsirotin.com/",
        "https://www.ecgprod.com/team/jason-sirotin/",
