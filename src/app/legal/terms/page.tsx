...
export default function TermsPage() {
  return <main className="subpage"><SubpageHeader /><div className="legal-page"><span className="legal-status">Draft pending legal and accounting review</span><h1>Terms and Consulting Agreement</h1><p className="legal-meta">Working version · August 2, 2026</p><article>
    ...
    <h2>Plans and payment</h2><ul><li>Guaranteed First Week: $350 paid once, approximately one hour of focused work during a seven-day working period, and no automatic conversion.</li><li>Monthly Partner: $1,000 per month paid automatically in advance only after the client affirmatively chooses to continue or purchases the monthly plan directly.</li></ul><p>Approved third-party expenses are additional. Pricing describes available capacity, not a client-facing minute-by-minute timecard.</p>
    <h2>First-week money-back guarantee</h2><p>The seven-day guarantee period begins when Jason confirms activation. Before the period ends, the client may choose to continue monthly or request a full refund of the $350 first-week service fee. Approved third-party expenses are not included in the refund. The first week never converts automatically; if the client takes no action, work pauses.</p>
    <h2>Cancellation</h2><p>The monthly plan requires 30 days’ written notice. Service and scheduled charges continue through the effective cancellation date. A request must be submitted through the client workspace or another accepted written channel.</p>
