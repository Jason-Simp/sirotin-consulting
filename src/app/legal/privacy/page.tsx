...
export default function PrivacyPage() {
  return <main className="subpage"><SubpageHeader /><div className="legal-page"><span className="legal-status">Draft pending professional review</span><h1>Privacy Policy</h1><p className="legal-meta">Working version · August 2, 2026</p><article>
    ...
    <h2>Information collected</h2><p>Information may include contact and company details, intake answers, newsletter consent and delivery records, account and workspace activity, messages, files, testing reports, approvals, agreement records, billing references, technical logs, and information you choose to provide while receiving services.</p>
    ...
    <h2>Email education and news</h2><p>If you explicitly subscribe, Resend delivers the requested educational sequence and occasional practical news. The first four messages in the five-part introductory sequence are educational; the fifth explains available ways to work with Jason. Each campaign email includes an unsubscribe link. Operational emails about payments, security, signed work, or active services are separate.</p>
    <h2>Your choices</h2><p>You may unsubscribe from educational email using the link in any campaign message. You may also request access, correction, or deletion of appropriate information, subject to contractual, operational, and legal retention needs.</p>
