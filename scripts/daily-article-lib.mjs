...
export const ARTICLE_SCHEMA = {
  ...
  properties: {
    ...
    title: { type: "string", minLength: 45, maxLength: 110 },
    description: { type: "string", minLength: 110, maxLength: 180 },
    ...
    imageAlt: { type: "string", minLength: 30, maxLength: 180 },
    imageCaption: { type: "string", minLength: 60, maxLength: 600 },
    keywords: { type: "array", minItems: 3, maxItems: 8, items: { type: "string", minLength: 3, maxLength: 100 } },
    intro: { type: "array", minItems: 2, maxItems: 4, items: { type: "string", minLength: 80, maxLength: 1400 } },
    sections: {
      type: "array",
      minItems: 8,
      maxItems: 14,
      items: {
        ...
        additionalProperties: false,
        properties: {
          heading: { type: "string", minLength: 12, maxLength: 140 },
          paragraphs: { type: "array", minItems: 1, maxItems: 4, items: { type: "string", minLength: 80, maxLength: 1600 } },
          bullets: { type: "array", minItems: 0, maxItems: 10, items: { type: "string", minLength: 12, maxLength: 300 } },
        },
        required: ["heading", "paragraphs", "bullets"],
      },
    },
    takeaway: { type: "string", minLength: 80, maxLength: 1000 },
    sources: {
      type: "array",
      minItems: 4,
      maxItems: 10,
      items: {
        ...
        additionalProperties: false,
        properties: {
          label: { type: "string", minLength: 8, maxLength: 180 },
          url: { type: "string" },
        },
        required: ["label", "url"],
      },
...
Include 4-6 distinct primary-authority sources spanning at least three domains; every source must have a descriptive label and a direct HTTPS URL. Select exactly one image path from the approved catalog. Return only JSON matching the supplied schema. Use ${date} for both published and updated. Put the strongest primary keyword first. Estimate readTime from the finished article.
